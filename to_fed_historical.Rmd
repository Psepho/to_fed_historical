...
```{r incumbents, echo=FALSE, warning=FALSE, message=FALSE}
...
- Gender is the strange one. We're getting a really strong signal for increased support of women for Conservatives, moderate support for Liberals, and strong negative support for NDP.
...
```{r comprehensive, echo=FALSE, warning=FALSE, message=FALSE}
